...
class TableModel
{
    ...
    static function makeMigration($config)
    {
        ...
        //
        $template_migration_up = config('artcrud_mg.template_migration_up');
        $template_migration_up = str_replace("%name_table%", $config['name_table'], $template_migration_up);
        $template_migration_down = config('artcrud_mg.template_migration_down');
    ...
    {
        $path_to_model = config("artcrud_mg.template_model.path_to_model");
        $new_name_space = config("artcrud_mg.template_model.new_name_space");
        $path_to_store = config("artcrud_mg.template_model.path_to_store") . "/" . ucfirst($config['name_table'] . ".php");
    ...
    static function makeRoute($config)
    {
        ...
        $route_name_prefix = config("artcrud_mg.template_route.route_name_prefix") . "." . $config['name_table'];
        $route_function = file_get_contents(config("artcrud_mg.template_route.template_path"));
        $route = file_get_contents(config("artcrud_mg.template_route.route_store_path"));
        $namespace_controller = config("artcrud_mg.template_controller.new_name_space") . "\\" . ucfirst($config['name_table']) . "Controller";
        ...
        file_put_contents(config("artcrud_mg.template_route.route_store_path"), $route);
        print(config("artcrud_mg.template_route.route_store_path") . " route file is updating!\n");
    ...
    {
        $path_to_controller = config("artcrud_mg.template_controller.template_path");
        $current_namespace = config("artcrud_mg.template_controller.new_name_space");
        $store_controller = config("artcrud_mg.template_controller.store_controller") . "/" . ucfirst($config['name_table']) . "Controller.php";
        $namespace_model = config("artcrud_mg.template_model.new_name_space") . "\\" . ucfirst($config['name_table']);
        ...
        $create_alias = config("artcrud_mg.template_views.create.short_alias") . "." . $config['name_table'] . ".create";
        $edit_alias = config("artcrud_mg.template_views.edit.short_alias") . "." . $config['name_table'] . ".edit";
        $index_alias = config("artcrud_mg.template_views.index.short_alias") . "." . $config['name_table'] . ".index";
        $show_alias = config("artcrud_mg.template_views.show.short_alias") . "." . $config['name_table'] . ".show";
        ...
        $route_index = config("artcrud_mg.template_route.route_name_prefix") . "." . $config['name_table'] . ".index";
        $route_edit = config("artcrud_mg.template_route.route_name_prefix") . "." . $config['name_table'] . ".edit";
    ...
    {
        $view_folder = config("artcrud_mg.template_views.create.path_to_store") . "/" . $config['name_table'];

        $route_index = config("artcrud_mg.template_route.route_name_prefix") . "." . $config['name_table'] . ".index";
        $route_name=config("artcrud_mg.template_route.route_name_prefix").".".$config['name_table'];
        $route_create = config("artcrud_mg.template_route.route_name_prefix") . "." . $config['name_table'] . ".create";
        $route_show = config("artcrud_mg.template_route.route_name_prefix") . "." . $config['name_table'] . ".show";
        $route_edit = config("artcrud_mg.template_route.route_name_prefix") . "." . $config['name_table'] . ".edit";
        $route_store = config("artcrud_mg.template_route.route_name_prefix") . "." . $config['name_table'] . ".store";
        $route_update = config("artcrud_mg.template_route.route_name_prefix") . "." . $config['name_table'] . ".update";
        $route_destroy = config("artcrud_mg.template_route.route_name_prefix") . "." . $config['name_table'] . ".destroy";


        $create_path = config("artcrud_mg.template_views.create.path_to_view");
        $create_to_view = config("artcrud_mg.template_views.create.path_to_store") . "/" . $config['name_table'] . "/create.blade.php";
        $create_alias = config("artcrud_mg.template_views.create.short_alias") . "." . $config['name_table'] . ".create";
        ...
        $edit_path = config("artcrud_mg.template_views.edit.path_to_view");
        $edit_to_view = config("artcrud_mg.template_views.edit.path_to_store") . "/" . $config['name_table'] . "/edit.blade.php";
        $edit_alias = config("artcrud_mg.template_views.edit.short_alias") . "." . $config['name_table'] . ".edit";
        ...
        $edit=str_replace("[ROUTE_PREFIX]",config("artcrud_mg.template_route.route_name_prefix") . "." . $config['name_table'],$edit );


        $index_path = config("artcrud_mg.template_views.index.path_to_view");
        $index_head=config("artcrud_mg.template_views.index.head_title");
        $index_head_content=file_get_contents($index_head);
        $index_to_view = config("artcrud_mg.template_views.index.path_to_store") . "/" . $config['name_table'] . "/index.blade.php";
        $index_alias = config("artcrud_mg.template_views.index.short_alias") . "." . $config['name_table'] . ".edit";
        ...
        $show_path = config("artcrud_mg.template_views.show.path_to_view");
        $show_to_view = config("artcrud_mg.template_views.show.path_to_store") . "/" . $config['name_table'] . "/show.blade.php";
        $show_alias = config("artcrud_mg.template_views.show.short_alias") . "." . $config['name_table'] . ".show";
