...
@section('content')
    ...
    <div class="row">
        ...
        <form action="{{ route("artcrud_mg.docreate") }}" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <button type="button" data-next_element="0" class="btn btn-success btn_add_field" data-url="{{ route("artcrud_mg.get_field") }}">
                    Добавить поле
                </button>
