...
@section('content')
    ...
    <form action="javascript:void(0);" class="crud_form" data-action="{{ route('[ROUTE_UPDATE]',$[name_table_little]->last_id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            <div class="row mb-2 mt-2">
                ...
                <div class="form-check form-switch  col-6">
                    <input class="form-check-input row_is_enable" data-route="{{ route("[ROUTE_PREFIX].toogle",$[name_table_little]->last_id) }}" type="checkbox" @if($[name_table_little]->enable==1) checked @endif >
                </div>
            </div>
            [EDIT_FIELDS]
